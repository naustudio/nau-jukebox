...
mejs.YouTubeApi = {
	...
	createEvent: function (player, pluginMediaElement, eventName) {
		...
		// console.log('Media Element CREATE EVENT', event.type, event.paused, event.ended);
		pluginMediaElement.dispatchEvent(event);
	},
...
'</object>';
	...
	handleStateChange: function(youTubeState, player, pluginMediaElement) {
		switch (youTubeState) {
			...
			case 5:
				// cued?
				// NOTE: this is a hack to fix the issue youtube player pause the next audio player when the
				// browser tab is on the background
				$(player.getIframe()).trigger({type: 'playercued', youtube: true});
				break;

		}
		// console.log('Youtube statusChange paused, ended', youTubeState, pluginMediaElement.paused, pluginMediaElement.ended);
	}
}
// IFRAME
